 ...
 *   指定されたアドレスの監視情報のシーケンス番号を返す。
 *   そのアドレスの監視情報がない場合は 0を返す。
 *   メモリ監視モードが COM_DEBUG_OFFの場合、常に 0を返す。
 * ---------------------------------------------------------------------------
 *   エラーは発生しない。
 * ===========================================================================
 * iPtrで指定したアドレスのメモリ監視情報があるかどうかチェックし結果を返す。
 * 0 が返る場合、該当するメモリ監視情報は存在しない。
 */
 ...
 *   指定されたアドレスの監視情報のシーケンス番号を返す。
 *   そのアドレスの監視情報がない場合は 0を返す。
 *   ファイル監視モードが COM_DEBUG_OFFの場合、常に 0を返す。
 * ---------------------------------------------------------------------------
 *   エラーは発生しない。
 * ===========================================================================
 * iPtrで指定したアドレスのファイル監視情報があるかどうかチェックし結果を返す。
 * 0 が返る場合、該当するファイル監視情報は存在しない。
 */
